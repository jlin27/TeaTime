...
public class IdlingResourceTest {
    ...
    private static final String FINISHED_LOADING_TEXT = "Your tea is ready!";
    ...
    public void idlingResourceTest() {
        ...
        // Verify that the TextView loads the finished loading text
        onView(withId(R.id.loading_text_view)).check(matches(withText(FINISHED_LOADING_TEXT)));
